...
public final class CollectionUtils {
   ...
   /*========
    ...
    /**
     * Returns a Set copy of the given array in analogy with {@link java.util.Arrays#asList}. But a difference is that
     * this method will copy the elements of the array into the set.
     * <p/>
